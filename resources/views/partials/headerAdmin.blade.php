<header class="app-header"><a class="app-header__logo" href="{{url('/')}}">Salazar&Salazar </a>
  ...
  <ul class="app-nav" >
	...
	<li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
	  <ul class="dropdown-menu settings-menu dropdown-menu-right">
		...
		<li><a class="dropdown-item" href=" {{url('/register')}} "><i class="fa fa-registered fa-lg"></i> Registrar Usuario</a></li>
